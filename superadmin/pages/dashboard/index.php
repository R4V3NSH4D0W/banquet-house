            ...
            <div class="cards">
                <div class="card">
                    <div class="card-content">
                        <?php
                        $result = mysqli_query($conn, "SELECT COUNT(*) AS total FROM tbservice where adminid='$super_id'");
                ...
                <div class="card">
                    <div class="card-content">
                        <?php
                        $result = mysqli_query($conn, "SELECT COUNT(*) AS total FROM images where admin_id='$super_id'");
                        ?>
                        <div class="number"><?php if ($result->num_rows > 0) {
                                                $row = $result->fetch_assoc();
                ...
                <div class="card">
                    <div class="card-content">
                        <?php
                        $result = mysqli_query($conn, "SELECT COUNT(*) AS total FROM Packages where admin_id='$super_id'");
                        ?>
                        <div class="number"><?php if ($result->num_rows > 0) {
                                                $row = $result->fetch_assoc();
